  ...
  <ion-page>
    ...
    <ion-content>
      ...
      >
        ...
        <ion-item
          id="packed-order-date-from-trigger"
          class="packed-order-date-filter packed-order-date-filter-fixed"
          button
          detail="false"
          lines="none"
        >
        ...
        <ion-item
          id="packed-order-date-thru-trigger"
          class="packed-order-date-filter packed-order-date-filter-fixed"
          button
          detail="false"
          lines="none"
      ...
      <ion-popover trigger="packed-order-date-from-trigger" trigger-action="click" :show-backdrop="false">
        <ion-datetime
          presentation="date"
      ...
      <ion-popover trigger="packed-order-date-thru-trigger" trigger-action="click" :show-backdrop="false">
        <ion-datetime
          presentation="date"
      ...
      <EmptyState
        ...
        :message="translate('Orders that are packed and awaiting pickup by carrier will appear here.')"
      />
...
function loadWorkflowOrders() {
  return orderStore.fetchWorkflowOrders(bucket, filters.value);
}
...
function packedOrderKey(order: WorkflowOrder) {
...
.packed-order-date-filter.packed-order-date-filter-fixed {
  flex: 0 0 11rem;
  min-width: 11rem;
  max-width: 11rem;
}
