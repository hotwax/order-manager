        ...
        <ion-card>
          <ion-card-header>
            <div class="card-header">
              ...
              <ion-button fill="clear" size="small" :disabled="!!refreshing" @click="refreshAll()" :aria-label="translate('Refresh')">
          ...
          <ion-list lines="none">
            ...
            <ion-item v-for="item in sessionFetchStatus" :key="item.label">
              ...
              <ion-button slot="end" fill="clear" @click="item.refresh()" :aria-label="translate('Refresh')">
            ...
            <ion-item v-for="domain in domains" :key="domain.name">
              ...
              <ion-button slot="end" fill="clear" :disabled="!!refreshing" @click="refreshDomain(domain.name)" :aria-label="translate('Refresh')">
