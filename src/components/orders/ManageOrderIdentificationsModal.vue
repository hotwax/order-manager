    ...
    <ion-list v-if="localIdentifications.length">
      ...
      >
        <template #end>
          ...
          <template v-else>
            <ion-button v-if="isRowUpdatable(identification)" fill="clear" @click="startEdit(identification)" :aria-label="translate('Edit identification')">
              <ion-icon slot="icon-only" :icon="createOutline" />
            </ion-button>
            <ion-button fill="clear" color="danger" :disabled="removingKey === rowKey(identification) || !isRowUpdatable(identification)" @click="removeIdentification(identification)" :aria-label="translate('Remove identification')">
